...
tree_hash_u64 tree_hash_dfs(const vector<vector<int>> &g, int u, int parent,
                            tree_hash_u64 seed) {
...
tree_hash_u64 rooted_tree_hash(const vector<vector<int>> &g, int root = 0,
                               tree_hash_u64 seed = 0x9e3779b97f4a7c15ULL) {
