...
| Dynamic 2D Segment Tree | `Dynamic_2D_Segment_Tree.cpp` | N/A (rectangle-add template) | Independent half-open rectangle-add/rectangle-sum oracle, including empty and zero-sized domains, negative updates, asymmetric shapes, and seeded random overlap sequences. |
